...
func Init(r *mux.Router) {
	...
	r.Handle("/api/posts/{id}", api(postsApi.Get)).Methods("GET")
	r.Handle("/api/posts/{id}", api(postsApi.Update)).Methods("PUT")
	r.Handle("/api/posts/{id}", api(postsApi.Delete)).Methods("DELETE")
